    ...
    <div class="bg-white shadow-lg rounded-2xl p-6 max-w-xl mx-auto">
        <form action="{{ route('admin.record.export.excel') }}" method="GET">
            <div class="mb-4">
                ...
                <select name="range" id="range" class="w-full px-3 py-2 border border-gray-300 rounded-md" onchange="toggleCustomDate()" required>
            ...
            <div class="flex justify-end">
                <button type="submit" class="px-6 py-2 bg-indigo-600 text-white rounded hover:bg-indigo-700 transition-colors">
