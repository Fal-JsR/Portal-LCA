    ...
    <div class="container mx-auto px-4 py-8">
        ...
        <div class="bg-white shadow-lg rounded-2xl p-6 max-w-2xl mx-auto">
            <form action="{{ route('admin.record.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-4">
                    <label for="nama_perusahaan_tambahan" class="block text-sm font-medium text-gray-700 mb-2">Nama
                        Perusahaan Tambahan</label>
                    <input type="text" name="nama_perusahaan_tambahan"
                        class="w-full px-3 py-2 border border-gray-300 rounded-md">
                </div>

                <div class="mb-4">
                    <label for="keluhan" class="block text-sm font-medium text-gray-700 mb-2">Keluhan / Kendala
                        Pekerjaan</label>
                    <textarea name="keluhan" rows="2" class="w-full px-3 py-2 border border-gray-300 rounded-md"
                        required></textarea>
                </div>
                ...
                <div class="mb-4">
                    <label for="keterangan_progress" class="block text-sm font-medium text-gray-700 mb-2">Keterangan Jika
                        Progress & Pending</label>
                    <textarea name="keterangan_progress" rows="2"
                        class="w-full px-3 py-2 border border-gray-300 rounded-md"></textarea>
                </div>

                <div class="mb-4">
                    <label for="kebutuhan_perangkat" class="block text-sm font-medium text-gray-700 mb-2">Kebutuhan
                        Perangkat</label>
                    <input type="text" name="kebutuhan_perangkat"
                        class="w-full px-3 py-2 border border-gray-300 rounded-md">
                </div>

                <div class="mb-4">
                    <label for="gambar[]" class="block text-sm font-medium text-gray-700 mb-2">Upload Eviden/Gambar (max
                        5)</label>
                    <input type="file" name="gambar[]" class="w-full px-3 py-2 border border-gray-300 rounded-md"
