        ...
        <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
            <div>
                <h1 class="text-2xl sm:text-3xl font-bold text-gray-800">
                    <i class="fas fa-building mr-2 sm:mr-3 text-blue-600"></i>{{ $instansi->nama_instansi }}
                </h1>
                <p class="text-gray-600 mt-2">Monitoring Traffic & Status</p>
            </div>
            <a href="{{ route('admin.trafik-client') }}" 
               class="w-full sm:w-auto text-center px-4 py-2 bg-gray-500 text-white rounded-lg hover:bg-gray-600">
            ...
            <div class="p-4 sm:p-6">
                ...
                @empty
                    <div class="text-center py-12">
                        <i class="fas fa-chart-bar text-gray-400 text-4xl sm:text-6xl mb-4"></i>
                        <p class="text-gray-500 text-base sm:text-lg mb-4">Belum ada grafik trafik yang ditambahkan.</p>
                        <a href="{{ route('admin.grafik.create') }}" 
                           class="inline-block px-4 sm:px-6 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700">
            ...
            <table class="min-w-full divide-y divide-gray-200">
                <thead class="bg-gray-50">
                    <tr>
                        ...
                        <th class="hidden lg:table-cell px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Bergabung</th>
                    </tr>
                </thead>
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="hidden sm:table-cell px-6 py-4 whitespace-nowrap text-sm text-gray-900">{{ $user->email }}</td>
                        <td class="px-3 sm:px-6 py-4 whitespace-nowrap">
                    ...
                    <tr>
                        <td colspan="5" class="px-3 sm:px-6 py-4 text-center text-gray-500">
                            ...
                            <p class="text-sm sm:text-base">Belum ada user terdaftar untuk instansi ini.</p>
                        </td>
                    </tr>
                    @endforelse
                </tbody>
...
<div id="popup" class="fixed inset-0 bg-black bg-opacity-90 z-50 hidden items-center justify-center p-4">
    <div class="bg-white rounded-lg w-full max-w-4xl max-h-screen p-4 sm:p-6 relative">
        <div class="flex justify-between items-center mb-4 border-b pb-3">
            <h2 id="popup-title" class="text-lg sm:text-xl font-semibold text-gray-800"></h2>
