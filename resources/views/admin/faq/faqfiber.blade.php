...
@section('content')
    ...
    <div class="container mx-auto px-4 py-10">
        <h1 class="text-4xl font-extrabold text-center text-blue-600 tracking-wide fade-up mb-2">Frequently Asked Question
            (FAQ) Fiber Optic</h1>
        ...
        <div class="max-w-4xl mx-auto space-y-4 fade-up">
            ...
            <div class="faq-item bg-blue-50 rounded-2xl overflow-hidden shadow-md">
                <div class="faq-question px-6 py-4 cursor-pointer flex items-center justify-between font-semibold text-gray-800 hover:bg-blue-100 transition-colors"
